    ...
    <div className="container mx-auto px-4">
      ...
      <section className="mb-16" data-aos="fade-up">
        <div className="py-12 px-8" data-aos="fade-right">
          ...
          <p className="text-lg leading-relaxed text-justify">
            Founded in 2024, <span className="text-[#02c39a]">Explore Nest </span>
            is dedicated to providing the ultimate travel tips and destination
            guides. Our mission is to offer high-quality, eco-friendly, and
            time-efficient resources that make your travel experience smoother
            and more enjoyable. From basic tips to in-depth guides, we ensure
            top-notch advice with the best practices and insights. We aim to
            redefine travel with a focus on convenience, customer satisfaction,
      ...
      <section className="mb-16" data-aos="fade-up">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          ...
          >
            ...
            <h3 className="text-lg font-medium text-gray-600">CEO & Founder</h3>
            <p className="text-gray-800 mt-2">
              Sarah founded Explore Nest with a passion for travel and customer
              service, aiming to bring top-tier travel guides to all adventurers.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-800 mt-2">
              John ensures that the daily operations of Explore Nest run
              smoothly, focusing on efficiency and quality in every guide.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-800 mt-2">
              Emily drives our marketing strategy, connecting with travelers and
              ensuring Explore Nest's brand reflects its quality and commitment
              to customer satisfaction.
            </p>
          </div>
        </div>
      ...
      <section className="mb-16" data-aos="fade-up">
        <div className="bg-gradient-to-r from-blue-400 to-blue-600 text-white py-12 px-8 rounded-lg shadow-lg">
          ...
          <div className="flex flex-col items-center space-y-6">
            <blockquote className="border-l-4 border-gray-300 pl-4 text-left max-w-lg">
              <p className="text-xl italic">
                "Explore Nest is simply the best. Their guides made my trip
                stress-free and enjoyable. Their eco-friendly tips are a big
                bonus!"
              </p>
              <footer className="mt-2 text-gray-300">- Alex Green</footer>
            </blockquote>
            <blockquote className="border-l-4 border-gray-300 pl-4 text-left max-w-lg">
              <p className="text-xl italic">
                "I was impressed by the professionalism of the team. Explore
                Nest delivers high-quality information and customer care every
                time."
              </p>
              <footer className="mt-2 text-gray-300">- Jane Smith</footer>
            </blockquote>
